...
This project had the sole requirement to communicate between an Computer and an Android device using the Bluetooth technology. One way communication only PC Client -> Android Server.
